...
public class AppointmentDAO {
	...
	public List<Appointment> getAllAppointmentByDoctorLogin1(int doctorId) {
		List<Appointment> list = new ArrayList<Appointment>();
		Appointment ap = null;
	...
	public Appointment getAppointmentById1(int id) {
	...
	public boolean updateCommentStatus1(int id, int doctId, String comm) {
		boolean f = false;
		try {
			String sql = "update appointment set status=? where id=? and doctor_id=?";
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public List<Appointment> getAllAppointment1() {
		List<Appointment> list = new ArrayList<Appointment>();
		Appointment ap = null;
